    ...
    public class CarDBContext: BaseDAL
    {
        ...
        public void AddNew(Car car)
        {
            try
            {
                ...
                if (pro == null)
                {
                    string SQLInsert = "Insert into Cars (CarID, CarName, Manufacturer, Price, ReleasedYear) " +
                    ...
                    parameters.Add(dataProvider.CreateParameter("@ReleasedYear", 4, car.ReleaseYear, DbType.Int32)); // Corrected parameter name
